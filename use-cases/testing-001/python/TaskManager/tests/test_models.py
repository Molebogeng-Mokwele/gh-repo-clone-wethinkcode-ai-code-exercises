...
class TestTaskModel(unittest.TestCase):
    def setUp(self):
        ...
        self.task = Task("Test Task", "Test description", priority=TaskPriority.HIGH)
    ...
    def test_update_changes_attributes_and_timestamp(self):
    ...
    def test_mark_as_done_updates_status_and_completed_at(self):
    ...
    def test_is_overdue_returns_false_when_task_done(self):
        self.task.due_date = self.now - timedelta(days=1)
        self.task.mark_as_done()
        self.assertFalse(self.task.is_overdue())
